...
func (d *BitumtimeWallet) Lookup(tx chainhash.Hash) (*Result, error) {
...
func (d *BitumtimeWallet) Construct(merkleRoot [sha256.Size]byte) (*chainhash.Hash, error) {
