...
import (
	...
	"github.com/bitum-project/bitumtime/bitumtimed/bitumtimewallet"
...
type FileSystem struct {
	...
	wallet *bitumtimewallet.BitumtimeWallet // Wallet context.
...
func New(root, cert, host string, enableCollections bool, passphrase []byte) (*FileSystem, error) {
	...
	// Runtime bits
	bitumtimewallet.UseLogger(log)
	fs.wallet, err = bitumtimewallet.New(cert, host, passphrase)
	if err != nil {
		return nil, err
	}
